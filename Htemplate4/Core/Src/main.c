...
float M1_1M  = 1;
float M1_10M = 58.848209;
float M1_14M = 93.999649;
float M1_18M = 126.423775;
float M1_20M = 141.029785;
//存放在1M-2M范围内最终得到的斜率
float M1_Unknown = 0;
...
//	HAL_TIM_Base_Start(&htim6);//打开定时器6
	...
	uint32_t gap = 1000000;
	printf("hello\r\n");
	loadstate(0);
	show_load_data(0);
//	for(scope_tmp = 10;scope_tmp < 300;scope_tmp++)
//	{
//		x_tmp = gap+gap*scope_tmp;
//		Freq_convert(x_tmp);
//		printf("x_tmp = %d\r\n",x_tmp/100000);
//		Delay_Us(100);
